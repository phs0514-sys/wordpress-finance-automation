...
4. Generate and upload three distinct original PNG visuals per article (overview, comparison, and checklist placements) using only Python standard-library drawing; no image API is called.
